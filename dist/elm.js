...
var $author$project$Timer$newTimer = F3(
	function (duration, _long, small) {
...
var $author$project$KandoroTask$setState = F2(
	function (state, _v0) {
		var task = _v0.a;
		return $author$project$KandoroTask$Task(
			_Utils_update(
		...
		return _Utils_Tuple2(
			{
				...
				tasks: _List_fromArray(
					[
						A2(
						$author$project$KandoroTask$setState,
						$author$project$KandoroTask$Done,
						...
						A3($author$project$KandoroTask$newTask, 'Add UI to CRUD tasks', 'Welp, at some point we should be able to add/edit/remove tasks', _List_Nil),
						A3($author$project$KandoroTask$newTask, 'Audio feedback when transitioning', 'So we know in which cycle we are (focus/ break/ longbreak)', _List_Nil),
						A3($author$project$KandoroTask$newTask, 'Allow a task in progress to be paused / resumed.', '', _List_Nil),
...
var $author$project$Main$Ticked = function (a) {
	return {$: 'Ticked', a: a};
};
...
var $author$project$Main$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 1000, $author$project$Main$Ticked);
};
var $author$project$Main$AddTimestamp = F2(
	function (a, b) {
		return {$: 'AddTimestamp', a: a, b: b};
	});
var $author$project$Timer$End = function (a) {
	return {$: 'End', a: a};
};
var $author$project$Main$EndedTimer = function (a) {
	return {$: 'EndedTimer', a: a};
};
var $author$project$Timer$Pause = function (a) {
	return {$: 'Pause', a: a};
};
var $author$project$Main$PausedTimer = function (a) {
	return {$: 'PausedTimer', a: a};
};
var $author$project$Timer$Restart = function (a) {
	return {$: 'Restart', a: a};
};
var $author$project$Main$RestartedTimer = function (a) {
	return {$: 'RestartedTimer', a: a};
};
var $author$project$Timer$Start = function (a) {
	return {$: 'Start', a: a};
};
var $author$project$Main$StartedTimer = function (a) {
	return {$: 'StartedTimer', a: a};
};
var $author$project$Main$TaskStateChanged = F2(
	function (a, b) {
		return {$: 'TaskStateChanged', a: a, b: b};
	});
var $author$project$Timer$TimestampTransition = F2(
	function (a, b) {
		return {$: 'TimestampTransition', a: a, b: b};
	});
var $author$project$Timer$Update = function (a) {
	return {$: 'Update', a: a};
};
...
var $author$project$Timer$endTimer = function (_v0) {
	var timer = _v0.a;
	...
	return $author$project$Timer$Timer(
		_Utils_update(
			timer,
			{
				state: $author$project$Timer$Ended,
				transitions: A2(
					$elm$core$List$cons,
					$author$project$Timer$TransitionWithoutTime(
						_Utils_Tuple2(oldState, $author$project$Timer$Ended)),
					timer.transitions)
			}));
};
var $author$project$Timer$Paused = {$: 'Paused'};
var $author$project$Timer$pauseTimer = function (_v0) {
	var timer = _v0.a;
	var oldState = function ($) {
		return $.state;
	}(timer);
	return $author$project$Timer$Timer(
		_Utils_update(
			timer,
			{
				...
				state: $author$project$Timer$Paused,
				transitions: A2(
					$elm$core$List$cons,
					$author$project$Timer$TransitionWithoutTime(
						_Utils_Tuple2(oldState, $author$project$Timer$Paused)),
					timer.transitions)
			}));
};
var $author$project$Timer$Reset = {$: 'Reset'};
var $author$project$Timer$resetTimer = function (_v0) {
	var timer = _v0.a;
	var oldState = function ($) {
		return $.state;
	}(timer);
	return $author$project$Timer$Timer(
		_Utils_update(
			...
			{
				currentValue: 0,
				state: $author$project$Timer$Reset,
				transitions: A2(
					$elm$core$List$cons,
					$author$project$Timer$TransitionWithoutTime(
						_Utils_Tuple2(oldState, $author$project$Timer$Reset)),
					timer.transitions)
			}));
};
var $author$project$Timer$Running = {$: 'Running'};
var $author$project$Timer$startTimer = function (_v0) {
	var timer = _v0.a;
	var oldState = function ($) {
		return $.state;
	}(timer);
	return $author$project$Timer$Timer(
		_Utils_update(
			timer,
			{
				state: $author$project$Timer$Running,
				transitions: A2(
					$elm$core$List$cons,
					$author$project$Timer$TransitionWithoutTime(
						_Utils_Tuple2(oldState, $author$project$Timer$Running)),
					timer.transitions)
			}));
};
var $author$project$Timer$TransitionWithTime = function (a) {
	return {$: 'TransitionWithTime', a: a};
};
...
var $author$project$Timer$timeStampLatestTransition = F2(
	function (_v0, time) {
		var timer = _v0.a;
		var _v1 = timer.transitions;
		if (!_v1.b) {
			return $author$project$Timer$Timer(timer);
		} else {
			if (_v1.a.$ === 'TransitionWithTime') {
				return $author$project$Timer$Timer(timer);
			} else {
				var _v2 = _v1.a.a;
				var from = _v2.a;
				...
				return $author$project$Timer$Timer(
					_Utils_update(
						timer,
						{
							transitions: A2(
								$elm$core$List$cons,
								$author$project$Timer$TransitionWithTime(
									_Utils_Tuple3(from, to, time)),
								A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									$elm$core$List$tail(timer.transitions)))
						}));
			}
		}
	});
var $author$project$Timer$LongBreak = {$: 'LongBreak'};
var $author$project$Timer$ShortBreak = {$: 'ShortBreak'};
var $author$project$Timer$getDurationInSeconds = function (_v0) {
	var _int = _v0.a;
	return _int;
};
var $author$project$Timer$filterTransitionByState = F2(
	function (state, transition) {
		if (transition.$ === 'TransitionWithTime') {
			var _v1 = transition.a;
			var from = _v1.a;
			return _Utils_eq(from, state);
		} else {
			var _v2 = transition.a;
			var from = _v2.a;
			return _Utils_eq(from, state);
		}
	});
var $author$project$Timer$getNextTypeOfBreak = function (transitions) {
	if (!transitions.b) {
		...
		var amountOfShortbreak = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				$author$project$Timer$filterTransitionByState($author$project$Timer$ShortBreak),
				transitions));
		var amountOfLongbreak = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				$author$project$Timer$filterTransitionByState($author$project$Timer$LongBreak),
				transitions));
		var amountOfPauses = amountOfShortbreak + amountOfLongbreak;
		return ((amountOfPauses > 0) && (!A2($elm$core$Basics$modBy, 4, amountOfPauses))) ? $author$project$Timer$LongBreak : $author$project$Timer$ShortBreak;
	}
};
var $author$project$Timer$updateTimerStateAndTransitions = F3(
	function (_v0, newState, value) {
		var timer = _v0.a;
		var transitions = (!_Utils_eq(newState, timer.state)) ? A2(
			$elm$core$List$cons,
			$author$project$Timer$TransitionWithoutTime(
				_Utils_Tuple2(timer.state, newState)),
			timer.transitions) : timer.transitions;
		return $author$project$Timer$Timer(
			_Utils_update(
				timer,
				{currentValue: value, state: newState, transitions: transitions}));
	});
var $author$project$Timer$updateTimer = function (_v0) {
	var timer = _v0.a;
	var _v1 = timer.state;
	switch (_v1.$) {
		case 'ShortBreak':
			return _Utils_eq(
				timer.currentValue,
				$author$project$Timer$getDurationInSeconds(timer.shortBreakDuration)) ? A3(
				$author$project$Timer$updateTimerStateAndTransitions,
				$author$project$Timer$Timer(timer),
				$author$project$Timer$Running,
				0) : A3(
				$author$project$Timer$updateTimerStateAndTransitions,
				$author$project$Timer$Timer(timer),
				$author$project$Timer$ShortBreak,
				timer.currentValue + 1);
		case 'LongBreak':
			return _Utils_eq(
				timer.currentValue,
				$author$project$Timer$getDurationInSeconds(timer.longBreakDuration)) ? A3(
				$author$project$Timer$updateTimerStateAndTransitions,
				$author$project$Timer$Timer(timer),
				$author$project$Timer$Running,
				0) : A3(
				$author$project$Timer$updateTimerStateAndTransitions,
				$author$project$Timer$Timer(timer),
				$author$project$Timer$LongBreak,
				timer.currentValue + 1);
		case 'Running':
			var nextBreak = $author$project$Timer$getNextTypeOfBreak(timer.transitions);
			return _Utils_eq(
				timer.currentValue,
				$author$project$Timer$getDurationInSeconds(timer.maximumDuration)) ? A3(
				$author$project$Timer$updateTimerStateAndTransitions,
				$author$project$Timer$Timer(timer),
				nextBreak,
				0) : A3(
...
var $author$project$Timer$update = function (msg) {
	switch (msg.$) {
		case 'Start':
			var timer = msg.a;
			return _Utils_Tuple2(
				$author$project$Timer$startTimer(timer),
				$elm$core$Platform$Cmd$none);
		case 'Pause':
			var timer = msg.a;
			return _Utils_Tuple2(
				$author$project$Timer$pauseTimer(timer),
				$elm$core$Platform$Cmd$none);
		case 'Restart':
			var timer = msg.a;
			return _Utils_Tuple2(
				$author$project$Timer$resetTimer(timer),
				$elm$core$Platform$Cmd$none);
		case 'Update':
			var timer = msg.a;
			return _Utils_Tuple2(
				$author$project$Timer$updateTimer(timer),
				$elm$core$Platform$Cmd$none);
		case 'End':
			var timer = msg.a;
			return _Utils_Tuple2(
...
var $author$project$Main$updateTimer = F3(
	function (msg, task, tasks) {
		return A2(
			$elm$core$List$map,
			function (t) {
				return _Utils_eq(
					$author$project$KandoroTask$getId(t),
					$author$project$KandoroTask$getId(task)) ? A2(
					$author$project$KandoroTask$setTimer,
					task,
					$author$project$Timer$update(
						msg(
							$author$project$KandoroTask$getTimer(t))).a) : t;
			},
			tasks);
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'StartedTimer':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A3($author$project$Main$updateTimer, $author$project$Timer$Start, task, model.tasks)
						}),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$AddTimestamp(task),
			...
			case 'PausedTimer':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A3($author$project$Main$updateTimer, $author$project$Timer$Pause, task, model.tasks)
						}),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$AddTimestamp(task),
			...
			case 'RestartedTimer':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A3($author$project$Main$updateTimer, $author$project$Timer$Restart, task, model.tasks)
						}),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$AddTimestamp(task),
			...
			case 'EndedTimer':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A3($author$project$Main$updateTimer, $author$project$Timer$End, task, model.tasks)
						}),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$AddTimestamp(task),
			...
			case 'AddTimestamp':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							tasks: A3(
								$author$project$Main$updateTimer,
					...
					function () {
						switch (state.$) {
							case 'Todo':
								return A2(
									$elm$core$Task$perform,
									$author$project$Main$RestartedTimer,
									$elm$core$Task$succeed(task));
							case 'Doing':
								return A2(
									$elm$core$Task$perform,
									$author$project$Main$StartedTimer,
									$elm$core$Task$succeed(task));
							case 'Done':
								return A2(
									$elm$core$Task$perform,
									$author$project$Main$EndedTimer,
									$elm$core$Task$succeed(task));
							default:
								return A2(
									$elm$core$Task$perform,
									$author$project$Main$PausedTimer,
									$elm$core$Task$succeed(task));
						}
					}());
			case 'LinkClicked':
			...
			default:
				var msg_ = msg.a;
				var _v3 = A2($norpan$elm_html5_drag_drop$Html5$DragDrop$update, msg_, model.dragDrop);
				var model_ = _v3.a;
				var result = _v3.b;
				if (result.$ === 'Nothing') {
					return _Utils_Tuple2(
					...
					var taskId = _v5.a;
					var state = _v5.b;
					var taskMaybe = $elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (t) {
								return _Utils_eq(
					...
					if (taskMaybe.$ === 'Nothing') {
						...
						var task = taskMaybe.a;
						var updatedTask = A2($author$project$KandoroTask$setState, state, task);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									tasks: A2(
										...
										function (t) {
											return _Utils_eq(
												taskId,
												$author$project$KandoroTask$getId(t)) ? updatedTask : t;
										},
										model.tasks)
								}),
							A2(
								$elm$core$Task$perform,
								$author$project$Main$TaskStateChanged(updatedTask),
								$elm$core$Task$succeed(state)));
					}
				}
		}
	});
var $author$project$Styles$Palette = function (a) {
	return {$: 'Palette', a: a};
};
var $author$project$Styles$PaletteProperties = function (a) {
	return {$: 'PaletteProperties', a: a};
};
...
var $author$project$Styles$defaultPalette = $author$project$Styles$Palette(
	{
		primary: $author$project$Styles$PaletteProperties(
			{
				color: $rtfeldman$elm_css$Css$hex('7b1fa2'),
				dark: $rtfeldman$elm_css$Css$hex('4a0072'),
				light: $rtfeldman$elm_css$Css$hex('ae52d4'),
				text: $rtfeldman$elm_css$Css$hex('ffffff')
			}),
		secondary: $author$project$Styles$PaletteProperties(
			{
				color: $rtfeldman$elm_css$Css$hex('aa00ff'),
				dark: $rtfeldman$elm_css$Css$hex('7200ca'),
				light: $rtfeldman$elm_css$Css$hex('e254ff'),
				text: $rtfeldman$elm_css$Css$hex('ffffff')
			})
	});
...
var $author$project$Styles$appBarHeight = 40;
...
var $author$project$Styles$cardBorderRadius = 3;
...
var $author$project$Styles$gap = 10;
...
var $author$project$Styles$listBorderRadius = 5;
var $author$project$Styles$listFooterHeight = 36;
var $author$project$Styles$listHeaderHeight = 36;
var $rtfeldman$elm_css$Css$listStyle = $rtfeldman$elm_css$Css$prop1('list-style');
var $author$project$Styles$listWidth = 300;
...
var $author$project$Styles$navBarHeight = 50;
...
var $author$project$Styles$scrollBarThickNess = 17;
...
var $author$project$Styles$toPx = function (_int) {
	return $rtfeldman$elm_css$Css$px(_int);
};
...
var $author$project$Styles$style = function (_v0) {
	var palette = _v0.a;
	var _v1 = palette.secondary;
	var secondaryStyle = _v1.a;
	var _v2 = palette.primary;
	var primaryStyle = _v2.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						A3(
							...
							F2(
								function (x, acc) {
									return $elm$core$String$fromInt(x) + ('px ' + acc);
								}),
							'',
							_List_fromArray(
								[$author$project$Styles$appBarHeight, $author$project$Styles$navBarHeight])) + ' 1fr'),
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$color(primaryStyle.text)
					])),
				A2(
				$rtfeldman$elm_css$Css$Global$class,
				'navbar--app-bar',
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$backgroundColor(primaryStyle.dark),
						$rtfeldman$elm_css$Css$fontSize(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$backgroundColor(primaryStyle.light),
										$rtfeldman$elm_css$Css$color(primaryStyle.text),
										A2(
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$borderTopLeftRadius(
										$author$project$Styles$toPx($author$project$Styles$listBorderRadius)),
										$rtfeldman$elm_css$Css$borderTopRightRadius(
										$author$project$Styles$toPx($author$project$Styles$listBorderRadius))
									])),
								A2(
...
var $author$project$Main$displayTaskAsListItem = function (task) {
	return A2(
		$elm$html$Html$li,
		A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$KandoroTask$getTitle(task))
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$KandoroTask$getDescription(task))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$StartedTimer(task))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Start Task')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$PausedTimer(task))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Pause task')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$RestartedTimer(task))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Reset task')
							]))
					]))
			]));
};
...
var $author$project$Main$displayTasksInList = F2(
...
var $author$project$Timer$stateToString = function (state) {
	switch (state.$) {
		case 'NotStarted':
			return 'Not started';
		case 'Running':
...
var $author$project$Timer$toHumanTime = function (time) {
	return A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		...
		_Utils_chr('0'),
		$elm$core$String$fromInt(
			A2($elm$time$Time$toMinute, $elm$time$Time$utc, time))) + (':' + A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
...
var $author$project$Timer$toString = function (_v0) {
	var timer = _v0.a;
	return 'Timer state: ' + ($author$project$Timer$stateToString(timer.state) + (' - ' + $author$project$Timer$toHumanTime(
		$elm$time$Time$millisToPosix(timer.currentValue * 1000))));
};
var $author$project$Main$displayTimer = function (task) {
	if (task.$ === 'Just') {
		var t = task.a;
		return A2(
			$elm$html$Html$p,
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					' Task ' + ($author$project$KandoroTask$getTitle(t) + (' is in progress. - ' + $author$project$Timer$toString(
						$author$project$KandoroTask$getTimer(t)))))
				]));
	} else {
		return A2($elm$html$Html$p, _List_Nil, _List_Nil);
	}
};
var $author$project$Timer$getState = function (_v0) {
	var timer = _v0.a;
	return timer.state;
};
var $author$project$Main$getTaskWithRunningTimer = function (model) {
	return $elm$core$List$head(
		A2(
			$elm$core$List$filter,
			function (task) {
				var _v0 = $author$project$Timer$getState(
					$author$project$KandoroTask$getTimer(task));
				switch (_v0.$) {
					case 'Running':
						return true;
					case 'ShortBreak':
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('navbar--app-bar')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('navbar--board-bar')
					]),
				_List_fromArray(
					[
						$author$project$Main$displayTimer(
						$author$project$Main$getTaskWithRunningTimer(model))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('board--content')
					]),
				_List_fromArray(
					[
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Styles$style($author$project$Styles$defaultPalette)),
